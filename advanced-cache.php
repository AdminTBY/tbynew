...
if ( ! @file_exists( '/bitnami/wordpress/wp-content/plugins/breeze/breeze.php' ) ) { return; }
$config['config_path'] = '/opt/bitnami/wordpress/wp-content/breeze-config/breeze-config.php';
...
if ( @file_exists( '/bitnami/wordpress/wp-content/plugins/breeze/inc/cache/execute-cache.php' ) ) {
	include_once '/bitnami/wordpress/wp-content/plugins/breeze/inc/cache/execute-cache.php';
}
