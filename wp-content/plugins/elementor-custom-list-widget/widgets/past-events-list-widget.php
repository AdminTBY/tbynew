...
class Elementor_Past_Events_List_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Past Events', 'elementor-custom-list-widget' );
	}
	...
	*/
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => esc_html__( 'Past Events', 'elementor-custom-list-widget' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Past Events', 'elementor-custom-list-widget' ),
				'placeholder' => esc_html__( 'Past Events', 'elementor-custom-list-widget' ),
			]
		);	
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Show View All Past Events Button', 'elementor-custom-list-widget' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Number Of Past Events', 'elementor-custom-list-widget' ),
...
<div class="latest-article-wrapper">
    ...
    <div class="latest-article-slider">
        <div class="article-block-main-outer swiper-container"
            <?php $this->print_render_attribute_string( 'past_event' ); ?>>



            <div class="past-article-block-wrapper">
                <?php
				$date = new DateTime();
				...
				$args =  array(
					'post_type' => 'tribe_events',
					'posts_per_page' => $settings['number_of_past_events'],
								...
								echo $get_only_start_day_name.' / '.$convert_start_date_with_name.'</br>'.$get_start_date_time.' - '.$get_end_date_time.' '.$get_event_timezone.'</br>'.$getevent_venue_city.''.$getevent_venue_country;								   
                                   ?> </p>
                                    <p class="upcoming-post-content description text-grey font-medium">
                                        <?php echo wp_trim_words( $upcoming_post_content, 25, '...' ); ?></p>
				...
				if($settings['view_all_past_events'] === 'yes'){
					$view_more_article_url      = get_field('view_all__past_events_url','option');
