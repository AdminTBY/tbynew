<?php
/**
* Plugin Name: Extended Search Addon
* Plugin URI: https://www.quantumcloud.com/products/plugins/
* Description: Extends Bot's search power to include almost any Custom Post Type beyond just Pages and Posts including WooCommerce
* Version: 1.5.6
* Author: QuantumCloud
...
register_activation_hook(__FILE__, 'qcld_wpbot_pt_search_options');
...
?>
	<div style="display: none;" class="wppt-settings-section" id="fuzzy-settings">
		<table class="form-table">
			...
			<tr valign="top">
				<th scope="row">Schedule to Generate New Data (Minutes)</th>
				<td>
					<?php
