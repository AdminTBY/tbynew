 ...
 * @since 8.0.0
 */
class MonsterInsights_Ecommerce_Compatibility_Check {
	/**
	 * Holds singleton instance
	 *
	 * @since 8.0.0
	 * @var MonsterInsights_Ecommerce_Compatibility_Check
	 */
	 ...
	 *
	 * @return MonsterInsights_Ecommerce_Compatibility_Check
	 * @since 8.0.0
	 */
	...
	public function display_php_notice() {
		...
		<div class="error">
			<p>
				...
				echo sprintf(
					esc_html__( 'Sorry, but your current version of PHP does not meet the minimum required version %1$s%2$s%3$s or newer to run MonsterInsights Ecommerce Addon properly. For information on how to upgrade your PHP version, contact your web host. %4$sClick here to return to the Dashboard%5$s.', 'monsterinsights-ecommerce' ),
					'<strong>',
	...
	public function display_wp_notice() {
		...
		<div class="error">
			<p>
				...
				echo sprintf(
					esc_html__( 'Sorry, but your WordPress version is not %1$s%2$s%3$s or newer. Please update your WordPress version and then activate MonsterInsights Ecommerce Addon. For help on how to update your WordPress %4$sclick here%5$s.', 'monsterinsights-ecommerce' ),
					'<strong>',
