 ...
 * @since 1.3.3
 */
class MonsterInsights_Google_Optimize_Compatibility_Check {
	/**
	 * Holds singleton instance
	 *
	 * @since 1.3.3
	 * @var MonsterInsights_Google_Optimize_Compatibility_Check
	 */
	 ...
	 *
	 * @return MonsterInsights_Google_Optimize_Compatibility_Check
	 * @since 1.3.3
	 */
	...
	public function display_php_notice() {
		...
		<div class="error">
			<p>
				...
				echo sprintf(
					esc_html__( 'Sorry, but your current version of PHP does not meet the minimum required version %1$s%2$s%3$s or newer to run MonsterInsights Google Optimize Addon properly. For information on how to upgrade your PHP version, contact your web host. %4$sClick here to return to the Dashboard%5$s.', 'monsterinsights-google-optimize' ),
					'<strong>',
	...
	public function display_wp_notice() {
		...
		<div class="error">
			<p>
				...
				echo sprintf(
					esc_html__( 'Sorry, but your WordPress version is not %1$s%2$s%3$s or newer. Please update your WordPress version and then activate MonsterInsights Google Optimize Addon. For help on how to update your WordPress %4$sclick here%5$s.', 'monsterinsights-google-optimize' ),
					'<strong>',
