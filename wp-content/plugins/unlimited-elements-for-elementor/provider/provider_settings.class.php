...
class UniteCreatorSettings extends UniteCreatorSettingsWork{
	...
	public function addTypographyDialogSettings(){
		...
		$this->addSelect("font_size", $arrFontSize, __("Font Size","unlimited-elements-for-elementor"));
		
		$this->addSelect("font_weight", $arrFontSize, __("Font Weight","unlimited-elements-for-elementor"));
