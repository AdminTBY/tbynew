...
class Qcld_WPBot_Admin_Resources {
    ...
    public function __construct() {
        ...
        if (is_admin() && !empty($_GET["page"]) && ($_GET["page"] == "email-subscription" || $_GET["page"] == "wbca-chat-history" || $_GET["page"] == "wbcs-botsessions-page"  || $_GET["page"] == "wbcs-botsessions-notansweredpage" || $_GET["page"] == "chatbot-crawl-page-list" || $_GET["page"] == "stop-word" || $_GET["page"] == "wpbot-panel" || $_GET["page"] == "wpbot-addons" || $_GET["page"] == "retarget-settings" || $_GET["page"] == "wpwc-settings-page" || $_GET["page"] == "language-center" || $_GET["page"] == "chatbot-menu" )) {
            add_action('admin_enqueue_scripts', array($this, 'qcld_wb_chatbot_admin_scripts'));
        }
    }
    ...
    public function qcld_wb_chatbot_admin_scripts($hook)
    {
        ...
        if (((!empty($_GET["page"])) && ($_GET["page"] == "wpbot")) || ($hook == "widgets.php") || ($_GET["page"] == "stop-word") || ($_GET["page"] == "wpbot-panel") || ($_GET["page"] == "retarget-settings") || ($_GET["page"] == "language-center") || ($_GET["page"] == "wpwc-settings-page") || ($_GET["page"] == "chatbot-menu") ) {
