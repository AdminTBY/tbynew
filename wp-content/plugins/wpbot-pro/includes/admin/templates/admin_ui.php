          ...
          <section id="section-flip-2">
            ...
            <div class="top-section">
              ...
              <div class="row light-grey shadow">
                <div class="col-xs-6">
                  <h4 class="qc-opt-title"> <?php echo esc_html__('OpenAI priority over all', 'wpchatbot'); ?> </h4>
                  <div class="cxsc-settings-blocks">
                    <input value="1" id="qcld_priority_openai_all" type="checkbox"
                                                   name="qcld_priority_openai_all" <?php echo(get_option('qcld_priority_openai_all') == 1 ? 'checked' : ''); ?>>
                    <label for="qcld_priority_openai_all"><?php echo esc_html__('OpenAI priority over all', 'wpchatbot'); ?> </label>
                  </div>
                </div>
                <div class="col-xs-6">
