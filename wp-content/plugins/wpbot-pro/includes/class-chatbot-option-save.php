        ...
        if (isset($_POST['_wpnonce']) && $_POST['_wpnonce']) {
            ...
            if (isset($_POST['submit'])) {
               ...
               if(isset( $_POST["disable_wp_chatbot"])){
                ...
                if(isset( $_POST["qcld_priority_openai_all"])){
                    $qcld_priority_openai_all = qcld_sanitize_field($_POST["qcld_priority_openai_all"]);
                }else{ $qcld_priority_openai_all='';}
                 update_option('qcld_priority_openai_all', stripslashes($qcld_priority_openai_all));
