<div class="wp-chatbot-start-content-single">
    <p><b><?php echo qcld_bot_startmenu()->helper->get_option( 'qlcd_wp_chatbot_startmenu_find_ansers' ); ?></b></p>
    
    <div class="qcwp-chatbot-search-article">
        <input type="text" autocomplete="off" placeholder="<?php echo qcld_bot_startmenu()->helper->get_option( 'qlcd_wp_chatbot_startmenu_search_articles' ); ?>" aria-label="Search" name="search" value=""  required>
