...
echo esc_html__( 'Total Visitors', 'ga-premium' ) . '   -   ' . esc_html( number_format_i18n( $total_visitors ) ) . "\n";
echo esc_html( $visitors_difference ) . "%\n\n";

echo esc_html__( 'Total Pageviews', 'ga-premium' ) . '   -   ' . esc_html( number_format_i18n( $total_pageviews ) ) . "\n";
