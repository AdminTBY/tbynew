				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer"
					...
					if ( ! empty( $header_image ) ) {
						...
						if ( ! empty( $header_image['2x'] ) ) {
							echo '<img style="max-width:300px;"  src="' . esc_url( $header_image['url'] ) . '" srcset="' . esc_url( $header_image['2x'] ) . ' 2x" alt="' . esc_attr__( 'Monthly Traffic Summary', 'ga-premium' ) . '" />';
						} else {
							echo '<img style="max-width:300px;"  src="' . esc_url( $header_image['url'] ) . '" alt="' . esc_attr__( 'Monthly Traffic Summary', 'ga-premium' ) . '" />';
						}
						echo '</a>';
						echo '</td></tr>';
					}
