...
class MonsterInsights_Email_Summaries {
	...
	public function add_weekly_cron_schedule( $schedules ) {
		$schedules['monsterinsights_email_summaries_weekly'] = array(
			...
			'display'  => esc_html__( 'Weekly MonsterInsights Email Summaries', 'ga-premium' ),
		);
	...
	public function set_template_args( $args ) {
		...
		$args['body']['description'] = esc_html__( 'Let’s take a look at how your website traffic performed in the past week.', 'ga-premium' );
