	...
	public function get_rendered_html( $atts ) {
		...
		foreach ( $posts as $post ) {
			...
			if ( $show_author ) {
				...
				$html .= '<span class="monsterinsights-widget-popular-posts-author">' . sprintf( __( 'by %s', 'google-analytics-for-wordpress' ), esc_html($post['author_name']) ) . '</span>';
			}
