...
class MonsterInsights_Popular_Posts_Widget_Sidebar extends WP_Widget {
	...
	public function form( $instance ) {
		...
		if ( ! empty( $theme['styles']['meta']['color'] ) ) {
			$this->color_input( 'meta_color', _x( 'Meta Color:', 'Widget', 'google-analytics-for-wordpress' ), $instance );
		}
		if ( ! empty( $theme['styles']['meta']['size'] ) ) {
			$this->size_input( 'meta_size', _x( 'Meta Font Size:', 'Widget', 'google-analytics-for-wordpress' ), $instance, $meta_font_sizes );
		}
		...
		<p>
			<?php if ( ! empty( $theme['styles']['meta']['author'] ) ) { ?>
				<label class="monsterinsights-label-block">
					...
					<?php esc_html_e( 'Display Author', 'google-analytics-for-wordpress' ); ?>
				</label>
			<?php } ?>
			<?php if ( ! empty( $theme['styles']['meta']['date'] ) ) { ?>
				<label class="monsterinsights-label-block">
					...
					<?php esc_html_e( 'Display Date', 'google-analytics-for-wordpress' ); ?>
				</label>
			<?php } ?>
			<?php if ( ! empty( $theme['styles']['meta']['comments'] ) ) { ?>
				<label class="monsterinsights-label-block">
					...
					<?php esc_html_e( 'Display Comments', 'google-analytics-for-wordpress' ); ?>
				</label>
			<?php } ?>
		</p>
		<?php
		...
		<p>
			...
			<select id="<?php echo esc_attr( $this->get_field_id( $name ) ); ?>"
				...
				<?php foreach ( $range as $font_size ) { ?>
					<option
						value="<?php echo absint( $font_size ); ?>" <?php selected( $instance[ $name ], $font_size ); ?>><?php printf( esc_html_x( '%dpx', 'google-analytics-for-wordpress' ), $font_size ); // phpcs:ignore ?></option>
				<?php } ?>
			</select>
		</p>
		<?php
