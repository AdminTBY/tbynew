...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post"
    ...
    <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
        ...
        <span class="tag text-grey font-italic font-medium"><em><?php esc_html_e( 'This will be how your name will be displayed in the account section and in reviews', 'woocommerce' ); ?></em></span>
    </p>
    <div class="clear"></div>
    ...
    <!-- <fieldset> -->
    <div class="title text-black font-bold"><?php esc_html_e( 'Password Change', 'woocommerce' ); ?></div>
